...
summaries = {
    ...
    "ANA DE MATOS": "Artista interdisciplinar que explora la condición femenina a través del grabado, la instalación, la escultura y el bordado, entrelazando técnicas artesanales tradicionales con conceptos contemporáneos. A lo largo de su trayectoria ha participado en numerosas exposiciones institucionales y ha recibido múltiples galardones por su trabajo centrado en la identidad y el papel de la mujer en la sociedad."
}
...
for a in artists:
    ...
    for k, v in summaries.items():
        if name_norm in normalize(k) or normalize(k) in name_norm:
            a['biography'] = v
            break
